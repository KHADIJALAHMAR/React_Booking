          ...
          <div className="auth_login_right">
            <div className="auth_login_logo">
              <div className="auth_logo_icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="45.255" height="45.255" viewBox="0 0 45.255 45.255">
                  <defs>
                  ...
                  <g id="Rectangle_4" data-name="Rectangle 4" transform="translate(22.627) rotate(45)" stroke="#fff" strokeWidth={1} fill="url(#linear-gradient)">
