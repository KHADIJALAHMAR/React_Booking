...
import Background from "../assest/img/R.jpg"


const  Header= ()=>{
    return(
< div className="khadija">
<nav className="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2 ">
        <div className="container-fluid py-1">
          <nav aria-label="breadcrumb">
            ...
            <h6 className="text-white font-weight-bolder ms-2"> Booking Stars</h6>
          </nav>
          <div
    ...
    {/* <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
      ...
      <img src={Background} alt=""  className="page-header min-height-300 max-with-1000 border-radius-xl mt-4" /> 
